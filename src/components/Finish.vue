        ...
        <form method="POST">
            <div class="columns">
                ...
                <div class="column is-4">
                    <cart />
                    <p class="control">
                        <router-link class="button is-fullwidth is-uppercase" :to="{ name: 'Payment'}">Back</router-link>
                        <br>
                        <button class="button is-primary is-fullwidth is-uppercase" @click="saveData()">Finish</button>
                    </p>
                </div>
            </div>
        </form>
...
export default {
    ...
    methods:{
        ...
        saveData(){
            ...
            this.$router.replace('/'+this.$route.params.subdomain+'/done')
        }
